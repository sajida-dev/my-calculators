            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">About My Calculators</h3>
                        <p className="text-gray-600 mb-4">
                            Your one-stop destination for all types of calculators. From basic math to specialized tools,
                            we provide accurate and easy-to-use calculators for every need.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center text-gray-600">
                                ...
                                <a href="mailto:contact@mycalculators.com" className="hover:text-blue-600 transition-colors duration-200">
                                    contact@mycalculators.com
                                </a>
                            </li>
                            <li className="flex items-center text-gray-600">
                            ...
                            <li className="flex items-center text-gray-600">
                                ...
                                <span>123 Calculator Street, Math City, MC 12345</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="mt-8 pt-8 border-t text-center text-gray-600">
                    <p>&copy; {new Date().getFullYear()} My Calculators. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
